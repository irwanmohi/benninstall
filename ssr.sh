...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/benkemad/benninstall/master/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://raw.githubusercontent.com/benkemad/benninstall/master/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://raw.githubusercontent.com/benkemad/benninstall/master/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/xp-ssr https://raw.githubusercontent.com/benkemad/benninstall/master/xp-ssr.sh && chmod +x /usr/bin/xp-ssr
wget -O /usr/bin/renewssr https://raw.githubusercontent.com/benkemad/benninstall/master/renewssr.sh && chmod +x /usr/bin/renewssr
